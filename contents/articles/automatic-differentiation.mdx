...
date: 2020-06-14
tags: [数学]
cover: https://cdn.jsdelivr.net/gh/tansongchen/images@master/automatic-differentiation.webp
...
显然，$\bar v_5 = 1$，我们据此将图反向迭代，每个节点上的取值取决于有多少前方的节点依赖了它。例如传播到 *v*0 时，发现这个节点只能通过 *v*2, *v*3 影响到 *y*，那么 *v̄*0 就可以表示为

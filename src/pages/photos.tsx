...
const Introduction = () => (
  <section
    ...
    style={{
      backgroundImage:
        "linear-gradient(to bottom, rgba(200,240,230,0.5), rgba(255,255,255,0.5))",
    }}
  >
    <div
...
const Preview = ({ name, exifImage }: Photo) => (
  <div
    className="box"
    style={{
      padding: 0,
...
export default function ({ data }: PageProps<Queries.PhotosQuery>) {
  const nodes: Photo[] = data.notionDatabase!.childrenNotionPage!.map(
    (page) => {
